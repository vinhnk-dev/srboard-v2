...
!function (NioApp, $) {
  ...
  NioApp.CurrentLink = function () {
    ...
    $(_link).each(function () {
      ...
      if (fileName.match(_self_link.replace('/agile', ''))) {
    ...
    if ($("#MaintenanceMenu").hasClass("active")) {
  ...
  NioApp.Slider.init = function () {
    ...
    var FakeDescription = document.querySelector('.fake-description')
    var MainDescription = document.querySelector('.main-description');

    if (FakeDescription && MainDescription) {
      setTimeout(function() {
        MainDescription.classList.remove('hidden');
        FakeDescription.classList.add('d-none');
      }, 200);
    }
...
//     $(".nk-block-tb").addClass("d-none");
//     $("#TaskTab").addClass("not-active");
//     $(".nk-block-project").removeClass("d-none");
//     $("#ProjectTab").removeClass("not-active");
//   });
// });

// $(document).ready(function(){
//   $("#TaskTab").click(function(){
//     $(".nk-block-tb").removeClass("d-none");
//     $("#TaskTab").removeClass("not-active");
//     $(".nk-block-project").addClass("d-none");
//     $("#ProjectTab").addClass("not-active");
//   });
// });
